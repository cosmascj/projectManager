...
import com.example.domoreeveryday.activities.TaskListActivity
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.findViewById<ImageButton>(R.id.ib_done_list_name).setOnClickListener {
                ...
                if (listName.isNotEmpty()) {
                    ...
                    Toast.makeText(context, "Pleas enter a list name", Toast.LENGTH_SHORT).show()
                }

            }

            holder.itemView.findViewById<ImageButton>(R.id.ib_edit_list_name).setOnClickListener {
                holder.itemView.findViewById<TextView>(R.id.et_edit_task_list_name)
                    .setText(model.title)
                holder.itemView.findViewById<View>(R.id.ll_title_view).visibility = View.GONE
            ...
            holder.itemView.findViewById<View>(R.id.ib_done_edit_list_name).setOnClickListener {
                var listName =
                    holder.itemView.findViewById<TextView>(R.id.et_edit_task_list_name).text.toString()
                if (listName.isNotEmpty()) {
                    if (context is TaskListActivity) {
                        context.updateTaskListAfterChange(position, listName, model)
                    }
                } else {
                    Toast.makeText(context, "Pleas enter a list name", Toast.LENGTH_SHORT).show()
                }
            ...
            holder.itemView.findViewById<ImageButton>(R.id.ib_close_card_name).setOnClickListener {
                ...
                holder.itemView.findViewById<TextView>(R.id.cv_add_card).visibility = View.GONE
            }


            holder.itemView.findViewById<View>(R.id.ib_done_card_name).setOnClickListener {
                var cardName =
