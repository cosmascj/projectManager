...
class LabelColorListAdapter(private val context: Context, private val list: ArrayList<String>,
private var mSelectedColors: String): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
